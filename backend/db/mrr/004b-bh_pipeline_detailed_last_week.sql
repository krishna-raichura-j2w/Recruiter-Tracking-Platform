...
--   L2/L3 Interview : 16, 17, 18, 19, 21, 22, 23, 58     (L2 + L3 outcomes + next-round proxies)
...
SELECT
    ...
    CASE
        ...
        WHEN aj.current_step IN (11, 12, 13, 14)                          THEN 'L1 Interview'
        WHEN aj.current_step IN (16, 17, 18, 19, 21, 22, 23, 58)          THEN 'L2/L3 Interview'
...
WHERE DATE(CONVERT_TZ(aj.updated_at, '+00:00', '+05:30'))
  ...
  AND aj.current_step IN (7, 11, 12, 13, 14, 16, 17, 18, 19, 21, 22, 23, 33, 44, 47, 58)
