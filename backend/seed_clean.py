...
seqs = [
    ...
    "assessments_id_seq",
    "validations_id_seq",
    "consultant_mails_id_seq",
    "submissions_id_seq",
    "submission_timeline_id_seq",
    "account_managers_id_seq",
    "clients_id_seq",
]
for s in seqs:
    try:
...
clients_data = [
    ...
    (
        ...
        "Semiconductor & embedded solutions",
    ),
    (
        "Sony India",
        "Sony",
...
def add_call(
    ...
    call_at,
    outcome="5_10min",
    notes="Candidate is interested and matches JD",
):
    log = CallLog(
...
def add_assessment(
    ...
    exp_ctc=14.0,
    notice=4,
    notes="Strong profile, good comm skills",
    pass_val="Yes",
):
    score = round((tech + soft) / 2, 2)
    auto_rec = (
        "Strong Submit" if score >= 4.0 else ("Consider" if score >= 3.25 else "Hold")
    )
    a = Assessment(
        candidate_id=candidate.id,
        caller_id=caller.id,
        ...
        comm_score=comm,
        role_art_score=tech,
        resume_skill_score=tech,
        tech_qa_score=tech,
        paraphrase_score=soft,
        confidence_score=soft,
        self_art_score=soft,
        overall_score=score,
        tech_score=tech,
...
def add_timeline(sub, stage, at, by=None):
    labels = {
        ...
        "final_scheduled": "Final Round Scheduled",
    ...
    for stage, at, by_user in stages_with_times:
        ...
        if stage in ("offer_rolled_out", "offer_accepted", "joined"):
            candidate.status = (
                ...
                if stage == "joined"
                else CandidateStatus.offer_rolled_out
            )
        elif stage in (
            "ta_rejected",
            "hm_rejected",
...
j = Job(
    client_name="GE Healthcare (GEHC)",
    role_title="Data Engineer",
    skill_stack="Python, Apache Spark, SQL, Databricks, AWS",
    work_mode=WorkMode.hybrid_2,
    headcount=3,
    location="Bangalore",
...
c2 = make_candidate(
    ...
    "Kavitha Nair",
    "9844100002",
    "kavitha.nair@gmail.com",
    "Chennai",
    "Python, Databricks, Spark, PySpark",
    "5-8 yrs",
    gagana,
    prathik,
    base,
...
add_assessment(
    ...
    notice=2,
    pass_val="No",
    notes="Good candidate but needs to brush up on Spark internals",
)
add_validation(
    c4,
    dl,
...
j2 = Job(
    ...
    assigned_sourcer_id=nithish.id,
    assigned_caller_id=ravi.id,
    deadline=dt(2026, 4, 20),  # OVERDUE
    created_at=dt(2026, 3, 18, 9),
    updated_at=dt(2026, 3, 18, 13),
)
db.add(j2)
db.flush()
J[2] = j2
...
c = make_candidate(
    ...
    "Mohammed Faiz",
    "9844200002",
    "mohammed.faiz@gmail.com",
    "Pune",
    "React, JavaScript, GraphQL, AWS",
    "3-5 yrs",
    nithish,
    ravi,
    base,
...
j3 = Job(
    client_name="Analog Devices India",
    ...
    assigned_sourcer_id=shwetha.id,
    assigned_caller_id=shwetha.id,
    deadline=dt(2026, 6, 1),
    created_at=dt(2026, 3, 20, 10),
    updated_at=dt(2026, 3, 20, 15),
)
db.add(j3)
db.flush()
J[3] = j3
...
c = make_candidate(
    ...
    "Bangalore",
    "C, RTOS (FreeRTOS), ARM Cortex-M, CAN, I2C",
    "5-7 yrs",
    shwetha,
    shwetha,
    base,
...
c = make_candidate(
    ...
    "Meenakshi Sundaram",
    "9844300002",
    "meenakshi.s@gmail.com",
    "Chennai",
    "C++, AUTOSAR, Embedded Linux, Yocto",
    "4-6 yrs",
    shwetha,
    shwetha,
    base,
...
c = make_candidate(
    ...
    "Rohan Bhat",
    "9844300003",
    "rohan.bhat@gmail.com",
    "Bangalore",
    "C, FreeRTOS, STM32, I2C, SPI",
    "3-5 yrs",
    shwetha,
    shwetha,
    base,
...
j4 = Job(
    ...
    created_at=dt(2026, 3, 22, 9),
    updated_at=dt(2026, 3, 22, 11),
)
db.add(j4)
db.flush()
J[4] = j4
...
c = make_candidate(
    ...
    "Bangalore",
    "Python, TensorFlow, Keras, MLflow, Docker",
    "4-6 yrs",
    gagana,
    prathik,
    base,
...
c = make_candidate(
    ...
    "Hyderabad",
    "Python, PyTorch, Kubeflow, AWS SageMaker",
    "5-7 yrs",
    nithish,
    prathik,
    base,
...
c = make_candidate(
    ...
    "Chennai",
    "Python, TensorFlow, NLP, Transformers",
    "3-5 yrs",
    gagana,
    prathik,
    base,
...
add_assessment(
    ...
    notice=2,
    pass_val="No",
    notes="Profile is junior, limited hands-on ML production experience",
)
add_validation(
    c,
    dl,
...
j5 = Job(
    ...
    caller_ids=json.dumps([ravi.id]),
    assigned_sourcer_id=subhashree.id,
    assigned_caller_id=ravi.id,
    deadline=dt(2026, 6, 10),
    created_at=dt(2026, 3, 25, 9),
    updated_at=dt(2026, 3, 25, 12),
)
db.add(j5)
db.flush()
J[5] = j5
...
c = make_candidate(
    ...
    "Noida",
    "Java, Kafka, Redis, Microservices, AWS",
    "4-6 yrs",
    subhashree,
    ravi,
    base,
...
j6 = Job(
    ...
    created_at=dt(2026, 4, 1, 10),
    updated_at=dt(2026, 4, 1, 16),
)
db.add(j6)
db.flush()
J[6] = j6
...
c = make_candidate(
    ...
    "Hyderabad",
    "Azure, Terraform, AKS, DevOps, Python",
    "9-12 yrs",
    nithish,
    ravi,
    base,
...
c = make_candidate(
    ...
    "Rekha Kumar",
    "9844600002",
    "rekha.kumar@gmail.com",
    "Bangalore",
    "Azure, GCP, Terraform, Python, Ansible",
    "8-10 yrs",
    nithish,
    ravi,
    base,
...
j7 = Job(
    ...
    created_at=dt(2026, 4, 5, 10),
    updated_at=dt(2026, 4, 5, 14),
)
db.add(j7)
db.flush()
J[7] = j7
...
c = make_candidate(
    ...
    "Aruna Krishnan",
    "9844700001",
    "aruna.krishnan@gmail.com",
    "Bangalore",
    "Java, AWS, DynamoDB, Kafka, Spring",
    "7-9 yrs",
    gagana,
    prathik,
    base,
...
j8 = Job(
    ...
    created_at=dt(2026, 4, 10, 9),
    updated_at=dt(2026, 4, 10, 12),
)
db.add(j8)
db.flush()
J[8] = j8
...
add_assessment(
    ...
    notice=4,
    pass_val="No",
    notes="Gaps in Terraform knowledge. Needs to revisit IaC concepts.",
)
add_validation(
    c,
    dl,
...
c = make_candidate(
    ...
    "Amritha Nair",
    "9844800004",
    "amritha.nair@gmail.com",
    "Kochi",
    "Docker, Jenkins, Python, Shell",
    "2-4 yrs",
    subhashree,
    None,
    base,
